            ...
            <div className=" max-w-[1350px] mx-auto px-5 py-12 sm:py-20">
                <div>
                    <div className="text-center">
                        ...
                        <h1 className="text-[24px] sm:text-[40px] font-inter font-bold bg-gradient-to-b from-black to-[#817200] bg-clip-text text-transparent text-[#262626] mb-1">IT Foundation Course</h1>
                        <p className="text-[14px] sm:text-[16px] leading-tight font-inter text-[#262626]">
