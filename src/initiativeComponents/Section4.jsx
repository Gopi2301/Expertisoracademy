                    ...
                    <div className='grid grid-cols-1 xl:grid-cols-2 gap-9 xl:gap-14 xl:items-center mt-7'>
                        ...
                        <div>
                            ...
                            <div className='sm:flex justify-center xl:justify-start gap-4 mt-2 xl:mt-5'>
                                ...
                                <div className='flex justify-center'>
                                    <JoinNowButton className='font-inter font-semibold text-black  text-[16px] leading-[100%] tracking-[0%] align-middle flex justify-center items-center border rounded-[4px] border-[#B6AC00] bg-[#FFF761] w-[335px] sm:w-[251px] h-[40px]'>
                                        Join Now
                                    </JoinNowButton>
                                </div>
