            ...
            <div className='pt-32 sm:pt-44 pb-24 px-3 sm:px-5' >
                ...
                <div className=' text-center'>
                    ...
                    <div className='relative  inline-block mb-4'>
                        <div className='flex justify-center'>
                            <div className=' flex  gap-2 items-center rounded-[8px] border border-[#C9BC5F] py-[6px] px-[8.5px] sm:p-[8.5px]'>
                                <img src={enroll} alt="" />
                                <p className='font-inter font-normal text-[12px] sm:text-[16px] leading-[100%] tracking-[0%] text-[#262626]'>7462+ students already enrolled</p>
                            </div>
                        ...
                        <p className="  mt-3 mb-5 sm:mb-0 sm:mt-4 font-inter font-normal text-[16px] sm:text-[24px] leading-snug tracking-normal text-center text-[#262626]">Learn Directly from Tamil Nadu's Top Tech Creators & Mentors!
                        </p>
                        <div className=' hidden sm:flex justify-center gap-4 mt-8 mb-10 lg:mb-14'>

                            
                            <div className='flex justify-center cursor-pointer'>
                                <JoinNowButton className='flex justify-center items-center  w-[171px] h-[56px] rounded-[8px]  bg-[radial-gradient(99.88%_99.88%_at_53.29%_100.71%,_#6D6100_0%,_#000000_100%)] border border-[#B6AC00]'>
                                    <div className="flex gap-3 items-center">
                                        <span className='font-inter font-semibold text-[16px] text-[#FFF201] leading-[100%] tracking-[0%] align-middle'>Join Now</span>
                    ...
                    <div className=' block sm:hidden justify-center gap-4 mt-12 '>
                        ...
                        <div className='flex justify-center cursor-pointer'>
                            <JoinNowButton className='flex justify-center items-center  w-[335px] h-[48px] rounded-[8px]  bg-[radial-gradient(99.88%_99.88%_at_53.29%_100.71%,_#6D6100_0%,_#000000_100%)] border border-[#B6AC00]'>
                                <div className="flex gap-3 items-center">
                                    <span className='font-inter font-semibold text-[14px] text-[#FFF201] leading-[100%] tracking-[0%] align-middle'>Join Now</span>
                                    <img src={right_arrow} alt="" />
                                </div>
                            </JoinNowButton>
                        </div>
