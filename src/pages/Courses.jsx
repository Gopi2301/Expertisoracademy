...
//     const { courses, categories, languages, mentors, selectedCategories, handleCheckboxChange, typeOfCourse,setCourseType,courseType } = useContext(CourseContext)
...
//             data = data.filter((value) =>
//                 selectedCategories.includes(value.category.trim().toLowerCase()) &&
//                 selectedCategories.includes(value.language.trim().toLowerCase())
//             );
//         }
...
//     }, [searched, selectedCategories, courseType])
...
//                                     <div className="">
//                                         {typeOfCourse.map((type, i) => {
//                                             const isChecked = courseType.toLowerCase().trim() == type.toLowerCase().trim()
//                                             return (
//                                                 <div key={type} onClick={() => setCourseType(type)} className={`py-2 pl-3  ${isChecked ? 'bg-[linear-gradient(270deg,_rgba(0,0,0,0.1)_0%,_rgba(255,242,0,0.1)_100%)] text-[#ffffff] border-l-2 border-l-[yellow]' : 'bg-transparent text-[#969696]'} cursor-pointer `}>
...
//                                             return (
//                                                 <label key={category} onClick={() => handleCheckboxChange(category)} className="flex items-center space-x-3 cursor-pointer">
...
//                                             return (
//                                                 <label key={language} onClick={() => handleCheckboxChange(language)} className="flex items-center space-x-3 cursor-pointer">
...
//                                             return (
//                                                 <label key={mentor} onClick={() => handleCheckboxChange(mentor)} className="flex items-center space-x-3 cursor-pointer">
//                                                     <div className={`h-4 w-4 flex items-center justify-center border rounded-sm ${isChecked ? 'bg-yellow border-yellow' : 'bg-black border-[#353535] text-[#969696]'}`}>
//                                                         {isChecked && <FaCheck className="text-black text-xs" />}
//                                                     </div>
...
//                         {/* right */}
//                         <div className='w-full md:w-[75%] lg:w-[79%] md:h-[90vh] md:overflow-y-auto md:scrollbar-hidden'>
...
//                                                 // data.type && data.type.toLowerCase() === "bundle course" ? (
//                                                 //     <BundleCourse key={i} course={data} />
//                                                 // ) : (
//                                                 //     <CoursesCard key={i} course={data} />
//                                                 // )
//                                             )
//                                         )
//                                     }
