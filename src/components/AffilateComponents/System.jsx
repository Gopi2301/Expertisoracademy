        ...
        <div>
            <div className=" px-3 sm:px-14 lg:px-20 py-9 sm:py-20 md:py-24 bg-[#0A0A0A]">
                <div>
                    ...
                    <p className="font-inter font-normal not-italic text-[14px] md:text-[18px] leading-[24px] tracking-[0%] text-center align-middle mt-4 text-[#B8B8B8]">{marketingAffiliate.system_section.system_desc.p1}<span className="lg:block">{marketingAffiliate.system_section.system_desc.p2}</span></p>
                </div>

                <div>
                    <div className="flex gap-4 justify-center mt-6 flex-wrap">
                        {marketingAffiliate.system_section.feature.map((data, i) => (
                            <div key={i}>
                    ...
                    <div className="mt-10 sm:mt-16 flex flex-col gap-5">
                        {marketingAffiliate.system_section.broken.map((data, i) => (
