...
import { assets } from '../../assets/assets'; // Start path from src if using vite aliasing or check relative path
// Note: You may need to adjust the assets import based on where you paste this folder.
                    ...
                    <div className='w-full relative' style={{ minHeight: '489px' }}>
                        <picture>
                            <source
                                ...
                                srcSet={assets.m_creators}
                                type="image/webp"
                                sizes="100vw"
                            />
                            <source
                                media="(min-width: 640px)"
                                srcSet={assets.creators}
                                type="image/webp"
                                sizes="100vw"
                            />
                            <img
                                ...
                                style={{
                                    aspectRatio: '375/449', // Default (mobile)
                                }}
                            />
                            <style>{`
                            @media (min-width: 640px) {
                                picture img {
                                    aspect-ratio: 1440/489 !important;
                                }
                            }
                        `}</style>
                        </picture>
