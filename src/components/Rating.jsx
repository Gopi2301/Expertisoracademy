...
const Rating = ({ data }) => {
  const backgroundStyle = data.bg_img
    ? {
        backgroundImage: `linear-gradient(90deg, #211A00 0%, rgba(33,26,0,0.4) 50.48%, #211A00 100%), url(${data.bg_img})`,
      }
    : {
        backgroundImage: `linear-gradient(90deg, #211A00 0%, rgba(33,26,0,0.4) 50.48%, #211A00 100%)`,
      }
