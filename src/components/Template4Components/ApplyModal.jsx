...
/**
 * Apply Modal Component for Template 4
 * Matches guna-dev Simple Elite styling with Zoho integration
 */
const ApplyModal = ({ open, onClose, courseName }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Extract course name from URL or use provided
            const course = courseName || extractCourseFromURL() || 'General Inquiry';

            // Combine country code and phone number
            const fullPhone = formData.countryCode + formData.phone;
            console.log('🚀 [Template4 ApplyModal] Submitting form...', { ...formData, phone: fullPhone, course });
            ...
            console.log('✅ [Template4 ApplyModal] Submission response:', result);
            ...
            console.error('❌ [Template4 ApplyModal] Submission error:', error);
