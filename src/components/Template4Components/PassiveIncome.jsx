...
const PassiveIncome = ({ p_income }) => {
    ...
    const DEFAULT_FORM_FIELDS = [
        ...
        { name: "phone", label: "Phone Number*", type: "tel", placeholder: "Enter WhatsApp Number", isPhone: true },
        { name: "education", label: "Educational qualification", type: "text", placeholder: "Bachelor of Engineering" },
        { name: "profile", label: "Current Profile", type: "select", options: ["Student", "Working Professional", "Business Owner"] }
    ];
    ...
    const benefits = p_income?.benefits || p_income?.what_you_get?.benefit || defaultBenefits;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const courseName = extractCourseFromURL() || 'Course Inquiry';
